...
def run(
    ...
    try:
        ...
        print("")
        print(f"[bold green]your_project_name finished, took {took.total_seconds()}s.[/bold green]")
        print("")
        print(
            "Thank you for using your_project_name! Please consider starring the project on github: https://github.com/dylanhogg/your_project_name"
        )
